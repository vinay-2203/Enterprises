      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
          ...
          <Card className="bg-white/95 backdrop-blur-sm shadow-strong p-6 md:p-8 animate-slide-up w-full max-w-4xl mx-auto h-[250px] flex flex-col overflow-y-auto">
            <Tabs value={searchType} onValueChange={setSearchType} className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-6">
                <TabsTrigger value="Property Type" className="flex items-center gap-2">
                  <Search className="h-4 w-4" />
                  Property Type
                </TabsTrigger>
                <TabsTrigger value="availability" className="flex items-center gap-2">
              ...
              <TabsContent value="Property Type" className="space-y-4">
                <div className="grid md:grid-cols-4 gap-4">
                  <div className="flex flex-col items-start">
                    ...
                    <Input id="property-type" placeholder="Project Name" className="h-12" />
                  </div>
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <Input id="Unit-Number" placeholder="Budget Range" className="h-12" />
                  </div>
